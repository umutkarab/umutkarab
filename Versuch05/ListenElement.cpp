 ...
 */
ListenElement::ListenElement(Student pData, ListenElement* pNext, ListenElement* pPrevious): /// added ListenElement* pPrevious
    data(pData), next(pNext), previous(pPrevious) /// added previous(pPrevious)
{
}
 ...
 * @param pPrevious Zeiger auf das vorherige Listenelement
 */
void ListenElement::setPrevious(ListenElement* pPrevious) /// added
{
    previous = pPrevious;
}
 ...
 */
ListenElement* ListenElement::getPrevious() const /// added
{
    return previous;
}
