 ...
 */
double Vektor::skalarProd(const Vektor& input) const  // skalarprodukt = Mit dem Skalarprodukt kannst du zwei Vektoren miteinander multiplizieren, die gleich groß sind.
{
	double skalarP = 0;
