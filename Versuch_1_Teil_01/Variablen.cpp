...
int main()
{
	...
	/* In alphabet there is 26 letters and according to ASCII uppercase letters are starting with 65 and ends with 90. */
	/* So it means we have to change every letter to uppercase */
	/* One more important thing to remember is to add 1 after doing modulo operation, for example if our 1st letter is "A" ( 65 ) and if we do modulo operation the result will be 0*/
